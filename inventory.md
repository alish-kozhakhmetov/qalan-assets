...
**Эталон 2 — Content Blocks**: пересобран. Мастеры организованы в 7 Figma Sections по назначению (Метрики / Персонажи / Чат / Функции и курсы / Ресурсы / Лиги / Экраны и промо). Без дублирования — используются оригинальные мастеры в секциях. Header + индекс-таблица 840px сверху. RU описание в каждой секции. Все textStyleId привязаны по ролям (0 unbound/Inter).
